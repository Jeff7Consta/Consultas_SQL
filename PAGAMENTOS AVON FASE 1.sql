...
--TRUNCATE TABLE TEMP_VINCENDAS_AVON 

--INSERT INTO TEMP_VINCENDAS_AVON
...
WHERE CONVERT(DATE, FORA.DT_PAGAMENTO, 103) between '2020-10-01' AND CONVERT(DATE, GETDATE(), 103)
AND FORA.FASE = '506'
