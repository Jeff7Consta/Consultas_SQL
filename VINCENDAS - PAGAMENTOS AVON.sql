...
CASE
	WHEN MONTH(CONVERT(DATE, B.DT_VENCIMENTO, 103)) = MONTH(GETDATE()) THEN 'SAFRA 0'
	WHEN MONTH(CONVERT(DATE, B.DT_VENCIMENTO, 103)) = MONTH(GETDATE())-1 THEN '8 A 30'
	WHEN MONTH(CONVERT(DATE, B.DT_VENCIMENTO, 103)) = MONTH(GETDATE())-2 THEN '31 A 60'
	WHEN MONTH(CONVERT(DATE, B.DT_VENCIMENTO, 103)) = MONTH(GETDATE())-3 THEN '60 A 90 ' ELSE 'DEMAIS SAFRAS' END AS SAFRA,
	CONVERT(DATE, B.DT_VENCIMENTO, 103) AS VENCIMENTO_SAFRA
...
CASE
	...
	WHEN MONTH(CONVERT(DATE, B.DT_VENCIMENTO, 103)) = MONTH(GETDATE())-1 THEN '8 A 30'
	WHEN MONTH(CONVERT(DATE, B.DT_VENCIMENTO, 103)) = MONTH(GETDATE())-2 THEN '31 A 60'
	WHEN MONTH(CONVERT(DATE, B.DT_VENCIMENTO, 103)) = MONTH(GETDATE())-3 THEN '60 A 90 ' ELSE 'DEMAIS SAFRAS' END,
	CONVERT(DATE, B.DT_VENCIMENTO, 103)

)FORA
WHERE CONVERT(DATE, FORA.VENCIMENTO, 103) between '2020-09-09' AND '2020-09-11' --CONVERT(DATE, GETDATE(), 103)


SELECT * FROM ##VINCENDAS
WHERE DT_PAGAMENTO IS NULL
AND DIR_IND = 'DIRETO'

--SELECT
--CASE
--	WHEN DT_PAGAMENTO IS NOT NULL THEN VENCIMENTO ELSE DT_PAGAMENTO END AS EFE_REAL,
--	CASE
--	WHEN DT_PAGAMENTO IS NULL THEN 'QUEBRA' ELSE 'PAGO' END AS STATUS_PGTO,
--VENCIMENTO,
--AGING_CLUSTER,
--AGING_CLUSTER_2,
--DT_PAGAMENTO,
...
--GROUP BY 
--CASE
--	WHEN DT_PAGAMENTO <>'' THEN VENCIMENTO ELSE DT_PAGAMENTO END,
--CASE
--	WHEN DT_PAGAMENTO IS NULL THEN 'QUEBRA' ELSE 'PAGO' END,
--VENCIMENTO,
--AGING_CLUSTER_2,
--AGING_CLUSTER,
--DT_PAGAMENTO,
